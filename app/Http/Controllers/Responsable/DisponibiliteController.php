...
class DisponibiliteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pages.responsable.disponibilite.index', compact('disponibilites'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.pages.responsable.disponibilite.create', compact('agents'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('responsable.disponibilite.index')->with('success', 'Disponibilité ajoutée avec succès.');
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.pages.responsable.disponibilite.show', compact('disponibilites'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.responsable.disponibilite.edit', compact('disponibilites', 'agents'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('responsable.disponibilite.index')->with('success', 'Disponibilité mise à jour avec succès.');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($deleted) {
            return redirect()->route('responsable.disponibilite.index')->with('success', 'Disponibilité supprimé avec succès.');
        } else {
            return redirect()->route('responsable.disponibilite.index')->with('fail', 'Une erreur s\'est produite lors de la suppression.');
        }
    }
}
