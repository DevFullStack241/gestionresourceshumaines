...
class AgentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pages.responsable.agent.index', compact('agents'));
    }
    ...
    {
        return view('backend.pages.responsable.agent.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('backend.pages.responsable.agent.show', compact('agents'));
    }
    ...
    public function edit(string $id)
    {
        // Trouver le agent par ID
        $agents = Agent::findOrFail($id);
        return view('backend.pages.responsable.agent.edit', compact('agents'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($saved) {
            return redirect()->route('responsable.agent.index')->with('success', 'Agent mis à jour avec succès.');
        } else {
            return redirect()->route('responsable.agent.edit', $id)->with('fail', 'Une erreur s\'est produite lors de la mise à jour.');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        if ($deleted) {
            return redirect()->route('responsable.agent.index')->with('success', 'Agent supprimé avec succès.');
        } else {
            return redirect()->route('responsable.agent.index')->with('fail', 'Une erreur s\'est produite lors de la suppression.');
        }
    }
}
