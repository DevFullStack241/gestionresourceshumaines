...
class BesponsableController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('backend.pages.responsable.besponsable.index', compact('responsables'));
    }
    ...
    {
        return view('backend.pages.responsable.besponsable.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('backend.pages.responsable.besponsable.show', compact('responsables'));
    }
    ...
    public function edit(string $id)
    {
        // Trouver le responsable par ID
        $responsables = Responsable::findOrFail($id);
        return view('backend.pages.responsable.besponsable.edit', compact('responsables'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($saved) {
            return redirect()->route('responsable.besponsable.index')->with('success', 'Responsable mis à jour avec succès.');
        } else {
            return redirect()->route('responsable.besponsable.edit', $id)->with('fail', 'Une erreur s\'est produite lors de la mise à jour.');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        if ($deleted) {
            return redirect()->route('responsable.besponsable.index')->with('success', 'Responsable supprimé avec succès.');
        } else {
            return redirect()->route('responsable.besponsable.index')->with('fail', 'Une erreur s\'est produite lors de la suppression.');
        }
    }
}
