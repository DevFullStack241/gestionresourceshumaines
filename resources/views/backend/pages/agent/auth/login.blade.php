            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-box bg-white box-shadow border-radius-10">
                    <div class="login-title">
                        <h2 class="text-center text-primary">Agent Connexion</h2>
                    </div>
                    <form action="{{ route('agent.login-handler') }}" method="POST">
                        @csrf
                        <x-alert.form-alert />
                        ...
                        <div class="row pb-30">
                            ...
                            <div class="col-6">
                                <div class="forgot-password">
                                    <a href="{{ route('agent.forgot-password') }}">Mot de passe oublié</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="input-group mb-0">
                                    <a class="btn btn-outline-primary btn-lg btn-block" href="{{ route('agent.register') }}"">Inscrivez-vous pour
                                        Créer un compte</a>
                                </div>
                            </div>
                        </div>
