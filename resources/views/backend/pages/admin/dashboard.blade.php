                ...
                <div class="calendar-wrap">
                    <div id="calendar" class="fc fc-bootstrap4 fc-ltr">
                        <div class="fc-toolbar fc-header-toolbar">
                            ...
                            <div class="fc-right"><button type="button" class="fc-today-button btn btn-primary disabled"
                                    disabled="">today</button>
                                <div class="btn-group"><button type="button" class="fc-prev-button btn btn-primary"
                                        aria-label="prev"><span class="fa fa-chevron-left"></span></button><button
                                        type="button" class="fc-next-button btn btn-primary" aria-label="next"><span
                                            class="fa fa-chevron-right"></span></button></div>
                            </div>
                            <div class="fc-center">
                                <div class="btn-group"><button type="button"
                                        class="fc-month-button btn btn-primary active">month</button><button
                                        type="button" class="fc-agendaWeek-button btn btn-primary ">week</button><button
                                        type="button" class="fc-agendaDay-button btn btn-primary ">day</button></div>
                            </div>
                                        ...
                                        <tr>
                                            <td class="">
                                                <div class="fc-scroller fc-day-grid-container"
                                                    style="overflow: hidden; height: 790.8px;">
                                                    <div class="fc-day-grid fc-unselectable">
                                                        <div class="fc-row fc-week table-bordered"
                                                            style="height: 131px;">
                                                            <div class="fc-bg">
                                                                <table class="table-bordered">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="fc-day  fc-sun fc-past"
                                                                                data-date="2024-09-01"></td>
                                                                            <td class="fc-day  fc-mon fc-past"
                                                                                data-date="2024-09-02"></td>
                                                                            <td class="fc-day  fc-tue fc-past"
                                                                                data-date="2024-09-03"></td>
                                                                            <td class="fc-day  fc-wed fc-past"
                                                                                data-date="2024-09-04"></td>
                                                                            <td class="fc-day  fc-thu fc-past"
                                                                                data-date="2024-09-05"></td>
                                                                            <td class="fc-day  fc-fri fc-past"
                                                                                data-date="2024-09-06"></td>
                                                                            <td class="fc-day  fc-sat fc-past"
                                                                                data-date="2024-09-07"></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                            ...
                                                            <div class="fc-bg">
                                                                <table class="table-bordered">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="fc-day  fc-sun fc-past"
                                                                                data-date="2024-09-08"></td>
                                                                            <td class="fc-day  fc-mon fc-past"
                                                                                data-date="2024-09-09"></td>
                                                                            <td class="fc-day  fc-tue fc-past"
                                                                                data-date="2024-09-10"></td>
                                                                            <td class="fc-day  fc-wed fc-past"
                                                                                data-date="2024-09-11"></td>
                                                                            <td class="fc-day  fc-thu fc-past"
                                                                                data-date="2024-09-12"></td>
                                                                            <td class="fc-day  fc-fri fc-past"
                                                                                data-date="2024-09-13"></td>
                                                                            <td class="fc-day  fc-sat fc-past"
                                                                                data-date="2024-09-14"></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                            ...
                                                            <div class="fc-bg">
                                                                <table class="table-bordered">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="fc-day  fc-sun fc-past"
                                                                                data-date="2024-09-15"></td>
                                                                            <td class="fc-day  fc-mon fc-past"
                                                                                data-date="2024-09-16"></td>
                                                                            <td class="fc-day  fc-tue fc-past"
                                                                                data-date="2024-09-17"></td>
                                                                            <td class="fc-day  fc-wed fc-past"
                                                                                data-date="2024-09-18"></td>
                                                                            <td class="fc-day  fc-thu fc-past"
                                                                                data-date="2024-09-19"></td>
                                                                            <td class="fc-day  fc-fri fc-past"
                                                                                data-date="2024-09-20"></td>
                                                                            <td class="fc-day  fc-sat fc-past"
                                                                                data-date="2024-09-21"></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                            ...
                                                            <div class="fc-bg">
                                                                <table class="table-bordered">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="fc-day  fc-sun fc-past"
                                                                                data-date="2024-09-22"></td>
                                                                            <td class="fc-day  fc-mon fc-today alert alert-info"
                                                                                data-date="2024-09-23"></td>
                                                                            <td class="fc-day  fc-tue fc-future"
                                                                                data-date="2024-09-24"></td>
                                                                            <td class="fc-day  fc-wed fc-future"
                                                                                data-date="2024-09-25"></td>
                                                                            <td class="fc-day  fc-thu fc-future"
                                                                                data-date="2024-09-26"></td>
                                                        ...
                                                        <div class="fc-row fc-week table-bordered"
                                                            ...
                                                            <div class="fc-bg">
                                                                <table class="table-bordered">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="fc-day  fc-sun fc-other-month fc-future"
                                                                                data-date="2024-10-06"></td>
                                                                            <td class="fc-day  fc-mon fc-other-month fc-future"
                                                                                data-date="2024-10-07"></td>
                                                                            <td class="fc-day  fc-tue fc-other-month fc-future"
                                                                                data-date="2024-10-08"></td>
                                                                            <td class="fc-day  fc-wed fc-other-month fc-future"
                                                                                data-date="2024-10-09"></td>
                                                                            <td class="fc-day  fc-thu fc-other-month fc-future"
                                                                                data-date="2024-10-10"></td>
                                                                            <td class="fc-day  fc-fri fc-other-month fc-future"
                                                                                data-date="2024-10-11"></td>
                                                                            <td class="fc-day  fc-sat fc-other-month fc-future"
                                                                                data-date="2024-10-12"></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            <td class="fc-day-top fc-sun fc-other-month fc-future"
                                                                                data-date="2024-10-06"><span
                                                                                    class="fc-day-number">6</span></td>
                                                                            <td class="fc-day-top fc-mon fc-other-month fc-future"
                                                                                data-date="2024-10-07"><span
                                                                                    class="fc-day-number">7</span></td>
                                                                            <td class="fc-day-top fc-tue fc-other-month fc-future"
                                                                                data-date="2024-10-08"><span
                                                                                    class="fc-day-number">8</span></td>
                                                                            <td class="fc-day-top fc-wed fc-other-month fc-future"
                                                                                data-date="2024-10-09"><span
                                                                                    class="fc-day-number">9</span></td>
                                                                            <td class="fc-day-top fc-thu fc-other-month fc-future"
                                                                                data-date="2024-10-10"><span
                                                                                    class="fc-day-number">10</span></td>
                                                                            <td class="fc-day-top fc-fri fc-other-month fc-future"
                                                                                data-date="2024-10-11"><span
                                                                                    class="fc-day-number">11</span></td>
                                                                            <td class="fc-day-top fc-sat fc-other-month fc-future"
                                                                                data-date="2024-10-12"><span
                                                                                    class="fc-day-number">12</span></td>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
