...
<div class="login-box bg-white box-shadow border-radius-10">
    ...
    <form action="{{ route('responsable.reset-password-handler') }}" method="POST">
        @csrf
        <x-alert.form-alert/>
        ...
        @enderror
        <div class="input-group custom">
            <input type="password" class="form-control form-control-lg" placeholder="Confirmer le nouveau mot de passe" name="confirm_new_password" value="{{ old('confirm_new_password') }}">
            <div class="input-group-append custom">
                <span class="input-group-text"><i class="dw dw-padlock1"></i></span>
            </div>
        </div>
