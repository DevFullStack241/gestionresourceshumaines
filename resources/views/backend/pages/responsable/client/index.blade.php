...
<div class="pd-20 card-box mb-30">
    <div class="clearfix mb-20">
        <div class="pull-left">
            <a href="{{ route('responsable.client.create') }}" class="btn btn-primary" role="button">
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                            <a class="dropdown-item" href="{{ route('responsable.client.show', $clients->id) }}"><i
                                    class="dw dw-eye"></i> View</a>
                            <a class="dropdown-item" href="{{ route('responsable.client.edit', $clients->id) }}"><i
                                    class="dw dw-edit2"></i> Edit</a>

                            <form action="{{ route('responsable.client.delete', $clients->id) }}" method="POST"
